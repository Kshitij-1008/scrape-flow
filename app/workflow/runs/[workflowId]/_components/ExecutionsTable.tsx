...
import { WorkflowExecution } from "@/lib/generated/prisma";
...
// To infer the initialData type in case it is not obvious
// type initialDataType = Awaited<ReturnType<typeof GetWorkflowExecutions>>;

export default function ExecutionsTable({workflowId, initialData} : {
    workflowId : string;
