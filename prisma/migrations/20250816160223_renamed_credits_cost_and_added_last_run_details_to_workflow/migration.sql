...
INSERT INTO "new_ExecutionPhase" ("completedAt", "id", "inputs", "name", "node", "number", "ouputs", "startedAt", "status", "userId", "workflowExecutionId") SELECT "completedAt", "id", "inputs", "name", "node", "number", "ouputs", "startedAt", "status", "userId", "workflowExecutionId" FROM "ExecutionPhase";
